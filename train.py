...
class LabelSomCE(nn.Module):
	...
	def forward(self,x,target,smoothing=0.1):
		...
		logprobs = F.log_softmax(x[1],dim=-1)
...
class DeepWriter_Train:
    def __init__(self,dataset='CERUG-EN',imgtype='png',mode='vertical'):
        ...
        basedir = 'FRAGNET_WriterIdentification_dataset_'+self.dataset+'_model_'+self.mode+'_aug_16'
        ...
        self.model = net.FragNet(1,num_classes=train_set.num_writer).to(self.device)
